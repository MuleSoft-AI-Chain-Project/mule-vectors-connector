...
public class OpenSearchStore extends BaseStoreService {
  ...
  public OpenSearchStore(StoreConfiguration storeConfiguration, OpenSearchStoreConnection openSearchStoreConnection,
  ...
  public EmbeddingStore<TextSegment> buildEmbeddingStore() {
    try {
      ...
      throw new ModuleException("Failed to build OpenSearch embedding store: " + e.getMessage(),
