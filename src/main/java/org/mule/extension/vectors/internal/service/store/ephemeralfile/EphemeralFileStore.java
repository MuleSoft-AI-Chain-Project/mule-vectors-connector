...
public class EphemeralFileStore extends BaseStoreService {
   ...
   */
  public EphemeralFileStore(StoreConfiguration storeConfiguration, EphemeralFileStoreConnection ephemeralFileStoreConnection,
  ...
  public EmbeddingStore<TextSegment> buildEmbeddingStore() {
    try {
      ...
      throw new ModuleException("Failed to build Ephemeral File store: " + e.getMessage(),
