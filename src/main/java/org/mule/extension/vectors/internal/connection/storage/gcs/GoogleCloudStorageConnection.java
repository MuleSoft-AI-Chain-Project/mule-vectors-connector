...
public class GoogleCloudStorageConnection implements BaseStorageConnection {
  ...
  public GoogleCloudStorageConnection(String projectId, String clientEmail, String clientId, String privateKeyId,
                                      String privateKey) {
  ...
  public void initialise() throws IOException {
    ...
    ServiceAccountCredentials serviceAccountCredentials =
        ServiceAccountCredentials.fromStream(new ByteArrayInputStream(buildJsonCredentials().getBytes()));
