...
public class MongoDBAtlasStore extends BaseStoreService {
  ...
  public MongoDBAtlasStore(StoreConfiguration storeConfiguration, MongoDBAtlasStoreConnection mongoDBAtlasStoreConnection,
  ...
  public EmbeddingStore<TextSegment> buildEmbeddingStore() {
    try {
      ...
      throw new ModuleException("Failed to build MongoDB embedding store: " + e.getMessage(),
