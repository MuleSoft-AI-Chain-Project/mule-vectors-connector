...
public class MistralAIEmbeddingModel extends DimensionAwareEmbeddingModel {
    ...
    private final MistralAIModelConnection connection;

    private MistralAIEmbeddingModel(MistralAIModelConnection connection, String modelName, Integer dimensions) {
    ...
    protected Integer knownDimension() {
        return this.dimensions != null ? this.dimensions : MistralAIModelName.knownDimension(this.modelName());
    }
    ...
    public static class Builder {
        private MistralAIModelConnection connection;
        private String modelName;
        private Integer dimensions;

        public Builder connection(MistralAIModelConnection connection) {
            this.connection = connection;
            return this;
        }
        ...
        public Builder modelName(MistralAIModelName modelName) {
        ...
        public MistralAIEmbeddingModel build() {
            return new MistralAIEmbeddingModel(connection, modelName, dimensions);
        }
    }
}