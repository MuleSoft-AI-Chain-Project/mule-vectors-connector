...
public class MistralAIService implements EmbeddingService {
  ...
  private CompletableFuture<String> generateTextEmbeddingsAsync(List<String> inputs, String modelName) {
    try {
      ...
      return HttpRequestHelper.executePostRequest(this.mistralAIModelConnection.getHttpClient(), EMBEDDINGS_ENDPOINT,
                                                  buildAuthHeaders(), body, (int) this.mistralAIModelConnection.getTimeout())
