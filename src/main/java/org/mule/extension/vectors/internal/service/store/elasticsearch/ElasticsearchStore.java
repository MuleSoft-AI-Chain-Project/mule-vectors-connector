...
public class ElasticsearchStore extends BaseStoreService {
  ...
  public ElasticsearchStore(StoreConfiguration storeConfiguration, ElasticsearchStoreConnection elasticsearchStoreConnection,
  ...
  public EmbeddingStore<TextSegment> buildEmbeddingStore() {
    try {
      ...
      throw new ModuleException("Failed to build Elasticsearch embedding store: " + e.getMessage(),
