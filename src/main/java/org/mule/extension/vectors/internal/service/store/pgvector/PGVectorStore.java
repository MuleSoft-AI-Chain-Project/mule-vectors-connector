...
public class PGVectorStore extends BaseStoreService {
   ...
   */
  public PGVectorStore(StoreConfiguration storeConfiguration, PGVectorStoreConnection pgVectorStoreConnection, String storeName,
  ...
  public EmbeddingStore<TextSegment> buildEmbeddingStore() {
    try {
      ...
      throw new ModuleException("Failed to build PGVector embedding store: " + e.getMessage(),
