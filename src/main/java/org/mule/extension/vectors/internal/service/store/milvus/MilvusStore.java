...
public class MilvusStore extends BaseStoreService {
  ...
  public MilvusStore(StoreConfiguration storeConfiguration, MilvusStoreConnection milvusStoreConnection, String storeName,
  ...
  public EmbeddingStore<TextSegment> buildEmbeddingStore() {
    try {
      ...
      throw new ModuleException("Failed to build Milvus embedding store: " + e.getMessage(),
