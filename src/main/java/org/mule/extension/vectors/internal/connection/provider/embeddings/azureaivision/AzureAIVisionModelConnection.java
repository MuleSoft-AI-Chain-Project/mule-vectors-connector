...
public class AzureAIVisionModelConnection implements BaseModelConnection {
  ...
  public void validate() {
    try {
      ...
      throw new ModuleException("Failed to validate connection to Azure AI Vision", MuleVectorsErrorType.INVALID_CONNECTION,
                                e.getCause());
    }
  }
  ...
  public Map<String, String> buildHeaders(String contentType) {
  ...
  public String handleErrorResponse(HttpResponse response, String message) {
    try {
