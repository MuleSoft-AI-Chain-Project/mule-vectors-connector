...
class AlloyDBStoreTest {
  ...
  void testGetFileIteratorReturnsNonNull() throws Exception {
    ...
    dev.langchain4j.community.store.embedding.alloydb.AlloyDBEngine alloyDBEngine =
        mock(dev.langchain4j.community.store.embedding.alloydb.AlloyDBEngine.class);
