...
class WeaviateStoreTest {
    ...
    void constructionAndBuildEmbeddingStoreSuccess() {
        ...
        WeaviateStoreConnection conn = new WeaviateStoreConnection(params, null) {
            ...
            @Override public Integer getPort() { return 8080; }
            @Override public boolean isSecuredGrpc() { return false; }
            @Override public Integer getGrpcPort() { return 50051; }
            @Override public boolean isUseGrpcForInserts() { return false; }
            @Override public boolean isAvoidDups() { return false; }
            @Override public String getConsistencyLevel() { return "ALL"; }
        };
    ...
    void buildEmbeddingStoreThrowsAuthenticationException() {
        ...
        setField(params, "consistencyLevel", "ALL");
        WeaviateStoreConnection conn = new WeaviateStoreConnection(params, null) {
            @Override public String getApikey() { throw new dev.langchain4j.exception.AuthenticationException("authfail"); }
        };
        String storeName = "testStore";
        QueryParameters queryParams = new QueryParameters();
        int dimension = 128;
    ...
    void buildEmbeddingStoreThrowsGenericException() {
        ...
        setField(params, "consistencyLevel", "ALL");
        WeaviateStoreConnection conn = new WeaviateStoreConnection(params, null) {
            @Override public String getHost() { throw new RuntimeException("fail"); }
        };
        String storeName = "testStore";
        QueryParameters queryParams = new QueryParameters();
        int dimension = 128;
