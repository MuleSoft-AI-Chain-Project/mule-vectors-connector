...
class MilvusIndexTypeProviderTest {

  @Test
  void resolve_shouldReturnAllIndexTypes() throws ValueResolvingException {
    MilvusIndexTypeProvider provider = new MilvusIndexTypeProvider();
  ...
  void getId_shouldReturnExpectedId() {
    assertThat(new MilvusIndexTypeProvider().getId()).isEqualTo("Milvus IndexType Value Provider");
  }
}
