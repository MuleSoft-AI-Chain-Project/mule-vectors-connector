...
class BaseModelConnectionProviderTest {
    ...
    @Mock TlsContextFactory tlsContext;
    @Mock HttpProxyConfig proxyConfig;
    @Mock HttpClientConfiguration config;

    TestProvider provider;

    static class TestProvider extends BaseModelConnectionProvider {
        @Override public BaseModelConnection connect() { return null; }
        @Override public void disconnect(BaseModelConnection c) {}
        @Override public org.mule.runtime.api.connection.ConnectionValidationResult validate(BaseModelConnection c) { return null; }
        // Expose for test
