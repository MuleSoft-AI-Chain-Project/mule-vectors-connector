...
class AlloyDBStoreConnectionParametersTest {
  ...
  private AlloyDBStoreConnectionParameters buildParams(String projectId, String region, String cluster, String instance,
                                                       String iamAccountEmail, String host, String ipType, int port,
  ...
  void shouldReturnAllSetValues() {
    AlloyDBStoreConnectionParameters params = buildParams(
                                                          "pid", "reg", "clu", "inst", "email", "host", "private", 1234, "db",
                                                          "user", "pass");
