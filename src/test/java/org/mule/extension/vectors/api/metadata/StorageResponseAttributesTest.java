...
class StorageResponseAttributesTest {
  ...
  void equalsShouldHandleThatNullFieldScenarios(String testCase, Map<String, Object> attributes1,
  ...
  private static Map<String, Object> createAttributes(String path, String fileName, String mimeType, Map<String, Object> metadata,
                                                      String extra) {
    Map<String, Object> attributes = new HashMap<>();
    if (path != null)
